...
var game_api_1 = require("./game-api");
function sleep(ms) {
    return new Promise(function (resolve) { return setTimeout(resolve, ms); });
}
function facadeExample() {
    return __awaiter(this, void 0, void 0, function () {
        var gameAPI, user, userId, HISTORY;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    gameAPI = new game_api_1["default"]();
                    user = { user_name: 'sean' };
                    userId = gameAPI.registerUser(user);
                ...
                case 3:
                    _a.sent();
                    HISTORY = gameAPI.getHistory();
                    console.log();
                    console.log('---- Reports History ----');
                    Object.keys(HISTORY).forEach(function (key) {
                        console.log("".concat(key, " : ").concat(HISTORY[key][0], " : ").concat(HISTORY[key][1]));
                    });
                    return [4 /*yield*/, sleep(1000)];
                case 4:
                    _a.sent();
